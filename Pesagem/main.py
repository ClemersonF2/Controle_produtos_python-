...
def janela_principal():
      ...
      # criando frames--------------------------------------------------------------------------------------------------------------------------------------------------
      frameCima = Frame(janela, width=1043, height=50, bg=Cores.cinza, relief=FLAT)
      frameCima.grid(row=0, column=0)

      frameMeio = Frame(janela, width=1043, height=303, bg=Cores.cinza, pady=20, relief=FLAT)
      frameMeio.grid(row=1, column=0, pady=1, padx=0, sticky=NSEW)

      frameBaixo = Frame(janela, width=1043, height=300, bg=Cores.cinza,relief=FLAT)
